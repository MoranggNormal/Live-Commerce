defmodule LiveCommerceWeb.CategoryLive.FormComponent do
  ...
  def update(%{category: category} = assigns, socket) do
    {:ok,
     ...
     |> assign(assigns)
     |> assign_new(:form, fn ->
       to_form(Products.change_category(category))
     end)}
  end

  @impl true
  def handle_event("validate", %{"category" => category_params}, socket) do
    changeset = Products.change_category(socket.assigns.category, category_params)
