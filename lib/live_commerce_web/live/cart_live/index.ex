defmodule LiveCommerceWeb.CartLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :carts, Carts.list_carts())}
  end
  ...
  @impl true
  def handle_info({LiveCommerceWeb.CartLive.FormComponent, {:saved, cart}}, socket) do
